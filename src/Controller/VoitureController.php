...
class VoitureController extends AbstractController
{
    ...
    public function new(Request $request, VoitureRepository $voitureRepository, MailerService $mailerService): Response
    {
        $voiture = new Voiture();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $mailerService->sendMail('testMail@univ-reims.fr', 'Hello :)', 'Votre mail a bien été envoyé.');
